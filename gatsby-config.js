...
const author = process.env.SITE_AUTHOR || 'Craig Couture'
const wordPressOriginShort = process.env.WORDPRESS_ORIGIN_SHORT
const wordPressOriginLong =
  process.env.WORDPRESS_ORIGIN_LONG || 'https://couturecraig.wordpress.com/'
const description =
  process.env.SITE_DESCRIPTION ||
  'Introduction to Craig Couture the Developer/Designer in Keene, NH'
const name = process.env.SITE_TITLE || 'CoutureCraig.com'
const short_name = process.env.SITE_SHORT_TITLE || 'Couture Craig'
const siteUrl = process.env.LONG_SITE_URL || 'https://www.couturecraig.com'
module.exports = {
  siteMetadata: {
    title: name,
    author,
